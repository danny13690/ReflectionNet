...
class QueryBlock(nn.Module):
    ...
    def __init__(self, in_features, num_hidden, out_features):
        super(QueryBlock, self).__init__()
        self.one = nn.Linear(in_features,num_hidden)
        self.two = nn.Linear(num_hidden,out_features)
